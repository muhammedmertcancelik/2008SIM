...
const styles = StyleSheet.create({
  ...
  statLabel: { fontSize: 11, fontWeight: '600', color: '#7f8c8d', marginBottom: 4 },
  statValue: { fontSize: 18, fontWeight: '800' },
  divider: { width: 1, height: 30, backgroundColor: 'rgba(0,0,0,0.1)' },
  infoText: { fontSize: 11, color: '#34495e', textAlign: 'center', marginTop: 8 },
  sectionTitle: { fontSize: 14, fontWeight: '800', color: '#2c3e50', marginBottom: 10 },
